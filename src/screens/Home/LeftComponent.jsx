...
import logo from '../../assets/code-stack-logo.png'
...
const LeftComponent = () => {
    ...
    return (
        <StyledLeftComponent>
            <ContentContainer>
                <Logo src={logo} alt="" />
                <MainHeading> <span>Code</span> Stack</MainHeading>
                ...
                <Link to="/signin">
                    <AddNewButton className="logout-btn"><span><BiLogOut/></span>Log Out</AddNewButton>
                </Link>
            </ContentContainer>
        </StyledLeftComponent>
    )
